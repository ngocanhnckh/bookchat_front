...
class DesktopAuthScreen extends StatefulWidget {
  @override
  _DesktopAuthScreenState createState() => _DesktopAuthScreenState();
}
                        ...
                        child: Center(child: Column(
                          ...
                          children: [
                            SizedBox(
                              ...
                              SizedBox(height: 10,),
                              Text("Mạng xã hội sách cho người Việt", style: TextStyle(fontSize: 20),)
                          ],
                                        ...
                                        TextSpan(
                                            ...
                                            recognizer: TapGestureRecognizer()
                                              ..onTap = () {
                                                Navigator.push(
                                                    context,
                                                    MaterialPageRoute(builder: (context) => DesktopRegisterScreen()),
                                                );
                                              }),
                                      ]),
                                    ),
